...
function CardInfo({image , name ,status ,id ,loading , theme}) {
...
if(loading === true){
  ...
  <div className={classNames("relative border border-spacing-9 rounded-lg w-[20rem] h-[30rem]  flex flex-col items-start gap-3 px-2 py-2",{
