export default function Skeleton () {
 return (<div className={"relative border border-spacing-9 rounded-lg w-[20rem] h-[30rem]  flex flex-col items-start gap-3 px-2 py-2 bg-gray-500  text-white animate-pulse "  } >
                    <div
                      alt="ssss"
                      className="rounded-lg  w-full h-[15rem] bg-gray-400"
